...
class PatientTypeCategoriesBillingTypeItemLink
{
    ...
    public static function viewByCategory(int $resourceId){
        $query = "SELECT * FROM Accounts.PatientTypeCategoriesBillingTypeItemLink a INNER JOIN Accounts.BillingTypeItems c ON a.BillingTypeItemID = c.BillingTypeItemID INNER JOIN Accounts.BillingType d ON c.BillingType = d.BillingTypeID WHERE a.PatientTypeCategoryID = $resourceId";
