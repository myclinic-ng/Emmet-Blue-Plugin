 ...
 */
namespace EmmetBlue\Plugins\Consultancy\ComplaintTemplate;
...
class ComplaintTemplate
{
    ...
    public static function create(array $data)
    {
        ...
        try
        {
            $result = DBQueryFactory::insert('Consultancy.ComplaintTemplates', [
    ...
    public static function createItem(array $data)
    {
        ...
        try
        {
            $result = DBQueryFactory::insert('Consultancy.ComplaintTemplateItems', [
    ...
    public static function view(int $resourceId)
    {
        ...
        $selectBuilder
            ->columns('*')
            ->from('Consultancy.ComplaintTemplates');
        if ($resourceId != 0){
    ...
    public static function viewItems(int $resourceId)
    {
        ...
        $selectBuilder
            ->columns('*')
            ->from('Consultancy.ComplaintTemplateItems')
    ...
    public static function editComplaintTemplate(int $resourceId, array $data)
    {
        ...
        try
        {
            ...
            $updateBuilder->table("Consultancy.ComplaintTemplates");
